  ...
  return (
    <section className="projects-page">
      <article className="page-card">
        <h2>О проекте BookFlow</h2>
        <p className="muted">
          BookFlow Store — онлайн-площадка, где пользователи выбирают книги, добавляют их в корзину и оформляют
          заказы, а сотрудники подтверждают и обрабатывают покупки.
        </p>
      </article>
